#General setup
#This script estimates impact of a shielding strategy for NY
...
initcond.nyc<-initcond[1,]
# base model
start = c(S.c = initcond.nyc$S_c, E.c =initcond.nyc$E_c, Is.c = initcond.nyc$Isym_c, Ia.c = initcond.nyc$Iasym_c, 
          Hs.c = initcond.nyc$Hsub_c, Hc.c =initcond.nyc$Hcri_c, D.c = initcond.nyc$D_c, R.c = initcond.nyc$R_c, 
          S.c.pos = 0, E.c.pos = 0, Is.c.pos = 0, Ia.c.pos = 0, R.c.pos =0, 
          
          S.a = initcond.nyc$S_a, E.a = initcond.nyc$E_a, Is.a = initcond.nyc$Isym_a, Ia.a = initcond.nyc$Iasym_a, 
          Hs.a = initcond.nyc$Hsub_a, Hc.a = initcond.nyc$Hcri_a, D.a = initcond.nyc$D_a, R.a = initcond.nyc$R_a, 
          S.a.pos = 0, E.a.pos = 0, Is.a.pos = 0, Ia.a.pos = 0, R.a.pos =0,
          
          S.rc = initcond.nyc$S_rc, E.rc = initcond.nyc$E_rc, Is.rc = initcond.nyc$Isym_rc, Ia.rc = initcond.nyc$Iasym_rc, 
          Hs.rc = initcond.nyc$Hsub_rc, Hc.rc = initcond.nyc$Hcri_rc, D.rc = initcond.nyc$D_rc, R.rc = initcond.nyc$R_rc, 
          S.rc.pos = 0, E.rc.pos = 0, Is.rc.pos = 0, Ia.rc.pos = 0, R.rc.pos =0,
          
          S.fc = initcond.nyc$S_fc, E.fc = initcond.nyc$E_fc, Is.fc = initcond.nyc$Isym_fc, Ia.fc = initcond.nyc$Iasym_fc, 
          Hs.fc = initcond.nyc$Hsub_fc, Hc.fc = initcond.nyc$Hcri_fc, D.fc = initcond.nyc$D_fc, R.fc = initcond.nyc$R_fc, 
          S.fc.pos = 0, E.fc.pos = 0, Is.fc.pos = 0, Ia.fc.pos = 0, R.fc.pos =0,
          
          S.e = initcond.nyc$S_e, E.e = initcond.nyc$E_e, Is.e = initcond.nyc$Isym_e, Ia.e = initcond.nyc$Iasym_e, 
          Hs.e = initcond.nyc$Hsub_e, Hc.e= initcond.nyc$Hcri_e, D.e = initcond.nyc$D_e, R.e = initcond.nyc$R_e, 
          S.e.pos = 0, E.e.pos = 0, Is.e.pos = 0, Ia.e.pos = 0, R.e.pos =0,
          H.pos = 0)


p<-as.numeric(initcond.nyc$symptomatic_fraction)
q<-as.numeric(initcond.nyc$q)
sd.other<-as.numeric(initcond.nyc$socialDistancing_other)
preduced<-as.numeric(initcond.nyc$p_reduced)
c<-as.numeric(initcond.nyc$c)
...
start.time.distance <- 26 
start.time.reopen <- 109 
school.start.time <- 194 
...
Total.time
save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/MetroFits/NYC_Reopening_SweepLong_AddVax_July2021.RData')
...
write.csv(End, '/Users/aliciakraay/Dropbox/COVIDShieldsEmory/NYC_vaccination.csv')
