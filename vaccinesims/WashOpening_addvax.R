#General setup
#This script estimates impact of a shielding strategy for Washington with vaccination added
...
initcond <- read.csv("/Users/aliciakraay/Dropbox/COVIDShieldsEmory/2021-06-17_MLEs.csv")
initcond<-initcond[3,]
#initcond10<-initcond[c(2:11),]
#means<-apply(initcond10, 2, mean)
# base model
start = c(S.c = initcond$S_c, E.c =initcond$E_c, Is.c = initcond$Isym_c, Ia.c = initcond$Iasym_c, 
          Hs.c = initcond$Hsub_c, Hc.c =initcond$Hcri_c, D.c = initcond$D_c, R.c = initcond$R_c, 
          S.c.pos = 0, E.c.pos = 0, Is.c.pos = 0, Ia.c.pos = 0, R.c.pos =0, 
          
          S.a = initcond$S_a, E.a = initcond$E_a, Is.a = initcond$Isym_a, Ia.a = initcond$Iasym_a, 
          Hs.a = initcond$Hsub_a, Hc.a = initcond$Hcri_a, D.a = initcond$D_a, R.a = initcond$R_a, 
          S.a.pos = 0, E.a.pos = 0, Is.a.pos = 0, Ia.a.pos = 0, R.a.pos =0,
          
          S.rc = initcond$S_rc, E.rc = initcond$E_rc, Is.rc = initcond$Isym_rc, Ia.rc = initcond$Iasym_rc, 
          Hs.rc = initcond$Hsub_rc, Hc.rc = initcond$Hcri_rc, D.rc = initcond$D_rc, R.rc = initcond$R_rc, 
          S.rc.pos = 0, E.rc.pos = 0, Is.rc.pos = 0, Ia.rc.pos = 0, R.rc.pos =0,
          
          S.fc = initcond$S_fc, E.fc = initcond$E_fc, Is.fc = initcond$Isym_fc, Ia.fc = initcond$Iasym_fc, 
          Hs.fc = initcond$Hsub_fc, Hc.fc = initcond$Hcri_fc, D.fc = initcond$D_fc, R.fc = initcond$R_fc, 
          S.fc.pos = 0, E.fc.pos = 0, Is.fc.pos = 0, Ia.fc.pos = 0, R.fc.pos =0,
          
          S.e = initcond$S_e, E.e = initcond$E_e, Is.e = initcond$Isym_e, Ia.e = initcond$Iasym_e, 
          Hs.e = initcond$Hsub_e, Hc.e= initcond$Hcri_e, D.e = initcond$D_e, R.e = initcond$R_e, 
          S.e.pos = 0, E.e.pos = 0, Is.e.pos = 0, Ia.e.pos = 0, R.e.pos =0,
          H.pos = 0)

p<-as.numeric(initcond$symptomatic_fraction)
q<-as.numeric(initcond$q)
sd.other<-as.numeric(initcond$socialDistancing_other)
preduced<-as.numeric(initcond$p_reduced)
c<-as.numeric(initcond$c)
...
# START DISTANCING: March 16, 2020
# REOPEN: May 31, 2020
# SCHOOLS OPEN: Sept 1, 2020

#Intervention timing based on local policies, washington here
start.time.distance <- 32 
start.time.reopen <- 108
school.start.time <- as.numeric(as.Date('10/01/2020', format='%m/%d/%Y')-as.Date('02/13/2020', format='%m/%d/%Y'))
...
Total.time
save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/MetroFits/Wash_Reopening_SweepLong_NoVax_July2021.RData')
#save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/MetroFits/Wash_Reopening_SweepLong_AddVax_July2021.RData')
...
#write.csv(End, '/Users/aliciakraay/Dropbox/COVIDShieldsEmory/Wash_vaccination.csv')
write.csv(End, '/Users/aliciakraay/Dropbox/COVIDShieldsEmory/Wash_novaccination.csv')
