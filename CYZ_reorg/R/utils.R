...
Get_Inits = function(Pars){
  ...
  X0['S_c'] = Pars$agestruc[1]*Pars$N-Pars$Isym_c0-Pars$Iasym_c0
  X0['S_a'] = Pars$agestruc[2]*Pars$frac_home*Pars$N-Pars$Isym_a0-Pars$Iasym_a0
  X0['S_rc'] = Pars$agestruc[2]*Pars$frac_reduced*Pars$N-Pars$Isym_rc0-Pars$Iasym_rc0
  X0['S_fc'] = Pars$agestruc[2]*Pars$frac_full*Pars$N-Pars$Isym_fc0-Pars$Iasym_fc0
  X0['S_e'] = Pars$agestruc[3]*Pars$N-Pars$Isym_e0-Pars$Iasym_e0
  
  # ... and add to symptomatic infected
  X0['Isym_c'] = Pars$Isym_c0
  X0['Isym_a'] = Pars$Isym_a0
  X0['Isym_rc'] = Pars$Isym_rc0
  X0['Isym_fc'] = Pars$Isym_fc0
  X0['Isym_e'] = Pars$Isym_e0
  
  # ... or add to aymptomatci infected
  X0['Iasym_c'] = Pars$Iasym_c0
  X0['Iasym_a'] = Pars$Iasym_a0
  X0['Iasym_rc'] = Pars$Iasym_rc0
  X0['Iasym_fc'] = Pars$Iasym_fc0
  X0['Iasym_e'] = Pars$Iasym_e0
