...
[tmin,ssmin]=fminsearchbnd(ssminfun,[0.02;0.25;0.3;0.25;10;1000;0], [0;0;0;0;1;0;0], [0.05;1;1;1;100000;100000;100]);
...
params = {
    ...
    {'I_{a0}^{sym}', tmin(5), 0, Inf}
    {'E_{a0}', tmin(6), 0, Inf}
    {'t_{targ}', tmin(7), 0, Inf}
...
save OUTPUT/2020-08-31_MCMCRun_sflor_PNAS.mat
