...
#Fitted parameters-simulating at the MLE for these--this is for S Florida
...
####Location specific parameters, here for sflor####
N=6168615
start.time.distance<-19
start.time.reopen<-83
school.start.time<-187
