...
interventions.sweep<-data.frame(testval=c(0, 30, 30, 30, 30, 365, 30, 365), 
                        specificity=c(0.5, 0.5, 0.96, 0.96, 0.998, 0.998, 0.998, 0.998),
                        ...
                        description=c('No testing', 
                                      ...
                                      'Suboptimal test, monthly testing, no shielding',
                                      'Suboptimal test, monthly testing, with shielding',
...
beep(sound=3)
#save.image('/Users/aliciakraay/Dropbox/COVID Shields Emory/MetroFits/Reopening_CredInt96100_NYC.RData')
#require(ggpubr)
#End2<-End[c(1:760),]
#write.csv(End, '/Users/aliciakraay/Dropbox/COVID Shields Emory/MetroFits/NYCEndVals_sets96to100.csv')
