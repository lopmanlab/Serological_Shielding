...
save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/Contour plots/SFlorcontour_Sweep_LockRelax_July9.RData')

load('~/Dropbox/COVIDShieldsEmory/Contour plots/SFlorcontour_Sweep_LockRelax_July9.RData')
#Figure 4
library(plotly)
...
figD <- figD %>% layout(xaxis=list(title="",
                        ...
                        yaxis=list(title="Testing", 
                                   ...
                                   type='log'))
figD.sflor<-figD %>%   colorbar(title='')
figD.sflor
...
figR <- figR %>% layout(xaxis=list(title="",
                        ...
                        yaxis=list(title="Testing", 
                                   ...
                                   tickvals=list(0, N/(365*100), N/(365*10), N/365, N/30),
                                   type='log'))
figR.sflor<-figR %>%   colorbar(title='')
figR.sflor

subplot(figD.sflor, figR.sflor, nrows=1, shareX=TRUE)
