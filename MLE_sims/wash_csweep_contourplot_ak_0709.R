...
save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/Contour plots/Washcontour_Sweep_LockRelax_July9.RData')


load('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/Contour plots/Washcontour_Sweep_LockRelax_July9.RData')
#Figure 4
library(plotly)
