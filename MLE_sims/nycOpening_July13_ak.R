...
# REOPEN: June 8, 2020
# SCHOOLS OPEN: October 1, 2020

#Intervention timing based on local policies
start.time.distance <- 26 
start.time.reopen <- as.numeric(as.Date('06/08/2020', format='%m/%d/%Y')-as.Date('02/20/2020', format='%m/%d/%Y')) 
school.start.time <- as.numeric(as.Date('10/01/2020', format='%m/%d/%Y')-as.Date('02/20/2020', format='%m/%d/%Y'))  #
...
start.time.test<-c(start.time.reopen, as.numeric(as.Date('11/01/2020', format='%m/%d/%Y')-as.Date('02/20/2020', format='%m/%d/%Y')))
sch.red<-0.5
...
Total.time
beep(sound=3)
save.image('/Users/aliciakraay/Dropbox/COVIDShieldsEmory/MetroFits/NY_Reopening_July14.RData')
require(ggpubr)
