...
X0(Pars.varNames=="S_a") = Pars.agestruc(2)*Pars.frac_home*Pars.N-Pars.Isym_a0-Pars.Iasym_a0-Pars.E_a0;
...
% ... and add to exposed
X0(Pars.varNames=="E_a") = Pars.E_a0;

% ... or add to symptomatic infected
