...
pars_wash.nWeeks = round(days(pars_wash.tf - pars_wash.t0)/7); % include t0.
...
pars_wash.tStart_reopen = 1+days(pars_wash.date_dist_end - pars_wash.t0); % REOPEN means SAH orders are lifted.
