...
pars_sflor.nWeeks = round(days(pars_sflor.tf - pars_sflor.t0)/7); % include t0.
...
pars_sflor.tStart_reopen = 1+days(pars_sflor.date_dist_end - pars_sflor.t0); % REOPEN means SAH orders are lifted.
