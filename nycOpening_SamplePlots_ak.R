...
initcond <- read.csv("/Users/aliciakraay/Dropbox/COVID Shields Emory/2020-10-07_nyc_chains_summary.csv")
...
Total.time
beep(sound=3)
save.image('/Users/aliciakraay/Dropbox/COVID Shields Emory/MetroFits/NY_Reopening_SweepLong.RData')
require(ggpubr)
